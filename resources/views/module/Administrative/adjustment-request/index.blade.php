<x-app-layout title="AstraMC Trucks & Equipments">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('adjustment-request.create') }}"
            ...
            <table class="min-w-full text-sm" id="main-table">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        @foreach(['ARQ No.','Department','Ref. No.','Nature Request','Requested By','Date & Time','Status'] as $col)
