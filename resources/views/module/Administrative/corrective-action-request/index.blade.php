<x-app-layout title="AstraMC Trucks & Equipments">
    ...
    <section>
        ...
        <div class="inline-flex border border-gray-200 rounded-md overflow-hidden mb-3 text-xs">
            <a href="#" class="px-3 py-1.5 bg-orange-500 text-white font-medium">
                All
            </a>
            <a href="#" class="px-3 py-1.5 bg-white text-gray-600 hover:bg-gray-50">
                Pending
            </a>
            <a href="#" class="px-3 py-1.5 bg-white text-gray-600 hover:bg-gray-50">
                Received
            ...
            <table class="min-w-full bg-white">
                ...
                <tr>
                    ...
                    <td class="p-3 text-xs">
                        <a href="#" class="text-blue-500 hover:text-blue-800"</a>
                    </td>
        ...
        <div class="md:flex mt-6 m-4">
            <p class="text-sm text-slate-500 flex-1">Showing 1 to 5 of 100 entries</p>
