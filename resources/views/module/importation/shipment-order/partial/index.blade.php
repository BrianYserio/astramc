    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="flex flex-wrap items-center gap-3 px-6 py-4 bg-gray-50 border-b border-gray-200">
            <a href="{{ route('shipment-order.index') }}"
               class="inline-flex items-center justify-center w-9 h-9 text-white bg-blue-600 rounded-lg transition shrink-0 hover:bg-blue-700"
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <x-select-field name="supplier_name" placeholder="Select supplier">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <x-select-field name="payment_terms" placeholder="Select Payment Terms">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <x-select-field name="currency_type" placeholder="Select Currency">
                            <option>PHP</option>
                            <option>USD</option>
                            <option>CNY</option>
                            <option>JPY</option>
