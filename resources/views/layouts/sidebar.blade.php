<nav class="bg-[#f9f9f9] h-screen fixed top-0 left-0 min-w-[240px] py-6 px-4 overflow-auto">
      <a href="#"><img src="{{asset('assets/img/new-astra-logo.png')}}" alt="logo" class="w-[200px]" /></a>
      ...
      <div class="mt-6">
        <div class="flex items-center cursor-pointer group collapsible-toggle">
          <h6 class="text-slate-800 group-hover:text-slate-900 text-[15px] font-semibold px-4 flex-1">Administrative</h6>
        ...
        <ul class="space-y-1 mt-2 pl-4 max-h-[500px] overflow-hidden transition-all duration-300">
          <li>
            <a href="{{route('transmittal.index')}}"
              class="text-slate-800 hover:text-slate-900 font-medium transition-all text-[14px] flex items-center hover:bg-[#efefef] rounded-md px-4 py-2">
          ...
          <li>
            <a href="{{route('marketing-service-request.index')}}"
              ...
              <span>Marketing Service Request</span>
            </a>
          </li>
          <li>
            <a href="{{route('product-service-request.index')}}"
              ...
              <span>Product Display Request</span>
            </a>
          </li>
          <li>
      ...
      <div class="mt-6">
        <div class="flex items-center cursor-pointer group collapsible-toggle">
          <h6 class="text-slate-800 group-hover:text-slate-900 text-[14px] font-semibold px-4 flex-1">Importation</h6>
          <svg xmlns="http://www.w3.org/2000/svg"
            class="arrow w-3 h-3 fill-slate-800 group-hover:fill-slate-900 transition-all" viewBox="0 0 492.004 492.004">
            <path
              d="M382.678 226.804 163.73 7.86C158.666 2.792 151.906 0 144.698 0s-13.968 2.792-19.032 7.86l-16.124 16.12c-10.492 10.504-10.492 27.576 0 38.064L293.398 245.9l-184.06 184.06c-5.064 5.068-7.86 11.824-7.86 19.028 0 7.212 2.796 13.968 7.86 19.04l16.124 16.116c5.068 5.068 11.824 7.86 19.032 7.86s13.968-2.792 19.032-7.86L382.678 265c5.076-5.084 7.864-11.872 7.848-19.088.016-7.244-2.772-14.028-7.848-19.108z"
              data-original="#000000" />
          </svg>
      ...
      <div class="mt-6">
        <div class="flex items-center cursor-pointer group collapsible-toggle">
          <h6 class="text-slate-800 group-hover:text-slate-900 text-[15px] font-semibold px-4 flex-1">Registration</h6>
          <svg xmlns="http://www.w3.org/2000/svg"
            class="arrow w-3 h-3 fill-slate-800 group-hover:fill-slate-900 transition-all" viewBox="0 0 492.004 492.004">
            <path
              d="M382.678 226.804 163.73 7.86C158.666 2.792 151.906 0 144.698 0s-13.968 2.792-19.032 7.86l-16.124 16.12c-10.492 10.504-10.492 27.576 0 38.064L293.398 245.9l-184.06 184.06c-5.064 5.068-7.86 11.824-7.86 19.028 0 7.212 2.796 13.968 7.86 19.04l16.124 16.116c5.068 5.068 11.824 7.86 19.032 7.86s13.968-2.792 19.032-7.86L382.678 265c5.076-5.084 7.864-11.872 7.848-19.088.016-7.244-2.772-14.028-7.848-19.108z"
        ...
        <ul class="space-y-1 mt-2 pl-4 max-h-0 overflow-hidden transition-all duration-300">
          ...
          <li>
            <a href="#"
              ...
              <span>Registration Fund(OLD)</span>
            </a>
          </li>
          <li>
            <a href="#"
              ...
              <span>Registration Fund(NEW)</span>
            </a>
          </li>
          <li>
            <a href="#"
          ...
          <li>
            <a href="#"
              ...
              <span>Transfer Of Ownership Fund</span>
            </a>
          </li>
          <li>
            <a href="#"
              ...
              <span>Registration Monitoring</span>
            </a>
          </li>
        </ul>
      </div>
      ...
      <div class="mt-6">
        <div class="flex items-center cursor-pointer group collapsible-toggle">
          <h6 class="text-slate-800 group-hover:text-slate-900 text-[15px] font-semibold px-4 flex-1">Action</h6>
          <svg xmlns="http://www.w3.org/2000/svg"
            class="arrow w-3 h-3 fill-slate-800 group-hover:fill-slate-900 transition-all" viewBox="0 0 492.004 492.004">
            <path
              d="M382.678 226.804 163.73 7.86C158.666 2.792 151.906 0 144.698 0s-13.968 2.792-19.032 7.86l-16.124 16.12c-10.492 10.504-10.492 27.576 0 38.064L293.398 245.9l-184.06 184.06c-5.064 5.068-7.86 11.824-7.86 19.028 0 7.212 2.796 13.968 7.86 19.04l16.124 16.116c5.068 5.068 11.824 7.86 19.032 7.86s13.968-2.792 19.032-7.86L382.678 265c5.076-5.084 7.864-11.872 7.848-19.088.016-7.244-2.772-14.028-7.848-19.108z"
